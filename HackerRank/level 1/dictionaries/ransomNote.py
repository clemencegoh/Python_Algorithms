...
them to create an untraceable replica of his ransom note. The words in his note are case-sensitive
...
:input: give me one grand today night
:output: give one grand today
"""


class RansomNoteSolution:
    def solve(self, magazine, note):
        """
        Concept:
            Put all in dict,
            take away during second loop
        """
        store = dict()
